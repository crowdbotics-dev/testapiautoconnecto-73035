...
## Project Structure
    ...
    ├── testapiautoconnecto_73035  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_73035`
...
2. Clone this repo and `cd testapiautoconnecto_73035`
